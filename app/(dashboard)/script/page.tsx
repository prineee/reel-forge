...
import {
  ...
  AlertCircle, BookMarked, Clock, Mic, Eye, ChevronDown, ChevronUp,
} from 'lucide-react'
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <span
              className={cn(
                'text-xs font-bold px-1.5 py-0.5 rounded bg-gradient-to-r text-transparent bg-clip-text',
                gradient
              )}
              style={{
...
export default function ScriptPage() {
  ...
  async function handleSave() {
    ...
    // Save all 5 scenes as the script field in videos
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    <div className="max-w-4xl space-y-6">
      <div>
        ...
        <p className="text-gray-400 text-sm">
          Generate a 60-second, 5-scene reel script with GPT-4 — ready to film.
        </p>
      </div>
        ...
        <CardContent>
          <form onSubmit={handleGenerate} className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <Button type="submit" disabled={loading || !productName.trim() || !targetAudience.trim()} size="md">
                {loading
      ...
      {loading && (
        <div className="space-y-3">
          ...
          <p className="text-center text-sm text-gray-500 animate-pulse">
            GPT-4 is crafting your 5-scene script…
          </p>
        </div>
      )}
      ...
      {result && !loading && (
        <div className="space-y-4">
          ...
          <div className="flex items-start justify-between gap-3">
            <div>
              <p className="text-xs text-gray-500 mb-0.5">Generated Script</p>
        ...
        <CardContent className="pt-0">
          {historyLoading ? (
            ...
            <p className="text-sm text-gray-500 py-4">
              No saved scripts yet. Generate one above!
            </p>
          ) : (
